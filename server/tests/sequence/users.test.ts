...
describe('Auth API', () => {
    ...
    const user1 = getNewRandomUser();
    const user2 = getNewRandomUser();
    const user3 = getNewRandomUser();
    const user4 = getNewRandomUser();
    ...
    // Test for user 1 registration
    it(`should register the logged-in user with the email '${user1.email}'`, async () => {
